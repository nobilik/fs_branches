...
class GroupedTagsServiceProvider extends ServiceProvider
{
    ...
    public function hooks()
    {
        ...
        \Eventy::addFilter('stylesheets', function($styles) {
            $styles[] = \Module::getPublicPath(NB_MODULE).'/css/module.css';
            $styles[] = \Module::getPublicPath(NB_MODULE).'/css/tagmanager.css';
            return $styles;
        });
        ...
        \Eventy::addFilter('javascripts', function($javascripts) {
            ...
            $javascripts[] = \Module::getPublicPath(NB_MODULE).'/js/module.js';
            $javascripts[] = \Module::getPublicPath(NB_MODULE).'/js/conversation.js';
            $javascripts[] = \Module::getPublicPath(NB_MODULE) .'/js/tag-delete-guard.js';
            return $javascripts;
        });
        ...
        // ---------------------------------------------------------------------
        $listenerClass = \Modules\NobilikBranches\Listeners\ConversationListener::class;
        ...
        \Eventy::addAction('layout.body_bottom', function() {
            echo view('nobilikbranches::partials.required_tags_modal')->render();
        });
    }
